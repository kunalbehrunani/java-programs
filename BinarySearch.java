...
public class BinarySearch {
    ...
    private static void binarySearch(int[] arr, int k) {
        ...
        while (i <= j && i >= 0 && j >= 0 && i < n && j < n) {
            ...
            if (arr[m] == k) {
                ...
                // PS: First and last occurence is found linearly. Can it be found using
                // patterns of binary search? ie. in logarathmic time complexiety.
    ...
    /*
     * This method finds if the given element k occurs in the given non-decreasing
     * array - "arr"
    ...
    private static void firstOccurence(int[] arr, int k) {
         ...
         * Finally when l and r are adjacent, our answer will be r as it lies in Block
         * B2.
         */
        ...
        if (arr[l] == k) {
            // We're checking this condition because as per our rule of invariant, we've
            // defined our Block B1 with elements less than element k.
            // If our left most element in array is equal to k itself, then it defies our
            // declaration of blocks as per rule of invariant
    ...
    private static void lastOccurence(int[] arr, int k) {
         ...
         * l will always stay in B1
         * r will always stay in B2
         * Finally when l and r are adjacent, our answer will be l as it lies in Block
         * B1.
         */
        ...
        if (arr[r] == k) {
            // We're checking this condition because as per our rule of invariant, we've
            // defined our Block B2 with elements greater than element k.
            // If our right most element in array is equal to k itself, then it defies our
            // declaration of blocks as per rule of invariant
    ...
    private static void sqrtRoot(int num) {
         ...
         * Since, we're dealing in floating point numbers, the precision we provide at
         * boundry will give us the desired precision in result.
         */
